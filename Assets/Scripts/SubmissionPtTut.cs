...
public class SubmissionPtTut : MonoBehaviour
{
    [SerializeField]
    private TutorialController tutorialController;

    private AssignmentController_Tut assignmentController;
    private List<S_Assignment> assmtQ;
    private SubmissionPanel submissionPanel; // not using this
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            assignmentController = FindObjectOfType<AssignmentController_Tut>();
        }
